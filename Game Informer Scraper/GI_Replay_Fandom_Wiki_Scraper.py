        ...
        for season in content.find_all("span", text=re.compile("Season")):
            ...
            for replayEpisode in season.parent.find_next_sibling("table").find_all("tr"):
                ...
                if dataArray:
                    ...
                    replayEpisodeTuple = scrapeReplayEpisode(dataArray, episodeNumber, replaySeason, scrapeEachEpisodeSite, scrapeEachGIArticle, scrapeYouTubeVideo)
...
def scrapeReplayEpisode(dataArray, episodeNumber, replaySeason, scrapeEachEpisodeSite = True, scrapeEachGIArticle = True, scrapeYouTubeVideo = True):
    """
    dataArray - array
    episodeNumber - positive int/float
    replaySeason - positive int

    Returns tuple consisting of:
    - Dictionary with key/values for replay episode
    - Flagged episode messages
    """
